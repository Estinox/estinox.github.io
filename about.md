...
If you haven't already guessed from the title, Centrally Distributed is a personal blog centered (bad pun intended) around machine learning and C++ programming. Although from time to time, you might see a few hobby posts tossed in, just to prove that I'm not a robot (or is that what a robot would say?).
...
Grew up around Toronto, Canada, and went to the University of Waterloo for its computer science program. Currently employed as a quant developer for a major bank in Manhattan, help the group develop automated market-making strategies within the interest-rate derivatives space.
